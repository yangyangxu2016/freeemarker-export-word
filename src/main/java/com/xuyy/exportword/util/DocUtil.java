...
public class DocUtil {
     ...
     * @param savePath     保存路径
     */
    public File createDoc(Map<String, Object> dataMap, String savePath, String downloadType, HttpServletRequest request) {
        ...
        try {
            ...
            configure.setServletContextForTemplateLoading(request.getServletContext(), savePath);
            //设置对象包装器
